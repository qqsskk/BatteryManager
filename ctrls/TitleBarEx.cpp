...
{
    m_pMiniButton->setStyleSheet("QPushButton{border: transparent; border-radius: none; background-color:#22252A;}"
    ...
    m_pMaxButton->setStyleSheet("QPushButton{border: transparent; border-radius: none; background-color:#22252A;}"
    ...
    m_pRestoreButton->setStyleSheet("QPushButton{border: transparent; border-radius: none; background-color:#22252A;}"
    ...
    m_pCloseButton->setStyleSheet("QPushButton{border: transparent; border-radius: none; background-color:#22252A;}"
...
void TitleBarEx::setIcon(const QString& fileName)
{
    ...
    m_pIconLabel->setStyleSheet("QLabel{background-color: #22252A; padding-left: 10px}");
}

void TitleBarEx::setTitle(const QString& title)
{
    m_pTitleLabel->setText(title);
    m_pTitleLabel->setStyleSheet("QLabel{color: #D13C4F; background-color: #22252A; font-size: 18pt; font-family: Microsoft YaHei;}");
}
