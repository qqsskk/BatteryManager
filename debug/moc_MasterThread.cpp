...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MasterThread_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(6, 39, 12) // "updateFinish"
...
void MasterThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MasterThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 3: _t->updateFinish(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MasterThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MasterThread::response)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MasterThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MasterThread::error)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MasterThread::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MasterThread::timeout)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MasterThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MasterThread::updateFinish)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MasterThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_MasterThread.data,
    qt_meta_data_MasterThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MasterThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MasterThread.stringdata0))
...
// SIGNAL 3
void MasterThread::updateFinish()
{
